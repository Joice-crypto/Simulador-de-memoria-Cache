...
def executa_MA():
    ...
    if politicaEscrita == 0 & numDeconjunto == 0 & politicaSubstituicao == 0: # se for write-through e #associativiade 2 vias e politica sub LFU
        ...
        if operacao == "r":
            ...
            if not conjunto:
                ...
                Conjunto.gravaRotulo(rotuloEndereco, politicaSubstituicao, politicaEscrita,memoriaPrincipal, endBinario)
            else:
                retornoRotulo = conjunto.procuraTAG(rotuloEndereco)
